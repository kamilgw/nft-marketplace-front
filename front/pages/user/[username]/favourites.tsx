...
const Page: NextPage<UserNftPageProps> = props => {
  return (
    <DefaultLayout>
      <UserNftPage deposit={false} userInfo={props.userInfo} />
      <NftPaginatedList data={props.allNfts} pageInfo={props.pageInfo} hideSortDropdown />
    </DefaultLayout>
  );
};
